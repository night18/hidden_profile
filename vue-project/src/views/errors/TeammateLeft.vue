  ...
  <div class="container">
    <div class="jumbotron container">
      ...
      <div class="content-area">
        <p>Unfortunately, one of your teammates has left the study. However, you can still earn your compensation based on your contributions.</p>
        <p>We appreciate your time and effort in participating.</p>
        <div v-if="bonus !== null">
          <p>Your current earnings: <strong>{{ bonus }}</strong></p>
