  ...
  <div class="container">
    <div class="jumbotron container">
      ...
      <div class="content-area">
        ...
        <p>Are you available on <strong class="highlight-date">TODAY Feb 3 at 5 PM E.T.</strong>? If so, click the button below to proceed to the consent form and begin the process.</p>
